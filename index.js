...
</li>`).join("")}const u="46452979-80039da2fd5690445e01cff1c",d="https://pixabay.com/api/";function p(r){const t=new URLSearchParams({key:u,q:r,image_type:"photo",orientation:"horizontal",safesearch:!0});return fetch(`${d}/?${t}`).then(a=>{if(!a.ok)throw new Error(a.status);return a.json()})}function c(){l.error({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight"})}const n={gallery:document.querySelector(".gallery"),searchForm:document.getElementById("searchPhotoForm"),loader:document.querySelector(".loader")};n.searchForm.addEventListener("submit",g);function g(r){r.preventDefault();const t=r.currentTarget,a=t.elements.q.value.trim();n.loader.classList.remove("loader-off"),p(a).then(o=>{if(n.gallery.innerHTML="",o.total===0){n.loader.classList.add("loader-off"),c();return}const e=f(o);n.loader.classList.add("loader-off"),n.gallery.insertAdjacentHTML("beforeend",e),new m(".gallery a",{captionsData:"alt",captionDelay:250}).refresh()}).catch(o=>{console.error(o),c()}).finally(()=>t.reset())}
